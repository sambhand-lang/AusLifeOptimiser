...
async function run() {
  ...
  const corrections = [
    ...
    { name: 'Toorak', state: 'VIC', price: 5800000, rent: 2200 },
    { name: 'Brighton (Vic.)', state: 'VIC', price: 3550000, rent: 1600 },
    { name: 'South Yarra', state: 'VIC', price: 2250000, rent: 1050 },
    { name: 'Reservoir', state: 'VIC', price: 950000, rent: 580 },
    { name: 'Berwick', state: 'VIC', price: 910000, rent: 550 },
    { name: 'Glen Waverley', state: 'VIC', price: 1800000, rent: 750 },
    { name: 'Frankston', state: 'VIC', price: 850000, rent: 520 },
    { name: 'Doncaster', state: 'VIC', price: 1600000, rent: 680 },
    { name: 'Kew', state: 'VIC', price: 3100000, rent: 1400 },
    { name: 'Hawthorn', state: 'VIC', price: 2850000, rent: 1300 },
    { name: 'Camberwell', state: 'VIC', price: 2650000, rent: 1200 },
    { name: 'Canterbury', state: 'VIC', price: 3400000, rent: 1500 },
    { name: 'Hawthorn East', state: 'VIC', price: 2600000, rent: 1150 },
