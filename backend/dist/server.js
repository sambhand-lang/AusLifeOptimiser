...
// Mount legacy JS metrics route (provides /api/suburb/metrics/:name)
// const suburbMetricsRouter = require('./routes/suburb_metrics');
...
// app.use('/api/suburb/metrics', suburbMetricsRouter);
